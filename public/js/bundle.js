...
/* harmony export */ });
/* harmony import */ var _components_Calander__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/Calander */ "./src/client/js/components/Calander.js");
/* harmony import */ var _components_Header__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/Header */ "./src/client/js/components/Header.js");
/* harmony import */ var _components_TodoModal__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/TodoModal */ "./src/client/js/components/TodoModal.js");
...
var App = function App($target) {
  ...
  var todoList = [];
  var today = new Date();
  var header = new _components_Header__WEBPACK_IMPORTED_MODULE_1__.default($target);
  var calander = new _components_Calander__WEBPACK_IMPORTED_MODULE_0__.default({
    $target: $target,
    today: today,
    dayList: dayList,
    monthList: monthList,
    ...
    onClick: function onClick(day) {
      todoModal.setState(day);
    }
  }); //TODO : Type

  var todoModal = new _components_TodoModal__WEBPACK_IMPORTED_MODULE_2__.default({
    $target: $target,
    todoList: todoList,
    calRender: function calRender() {
      calander.render();
    }
  });
};
...
/***/ "./src/client/js/components/Calander.js":
/*!**********************************************!*\
  !*** ./src/client/js/components/Calander.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ Calander)
/* harmony export */ });
...
var Calander = /*#__PURE__*/function () {
  function Calander(_ref) {
    ...
    _defineProperty(this, "prevMonth", function (today) {
      return new Date(today.getFullYear(), today.getMonth() - 1, today.getDate());
    });

    _defineProperty(this, "nextMonth", function (today) {
      return new Date(today.getFullYear(), today.getMonth() + 1, today.getDate());
    });
  ...
  _createClass(Calander, [{
    ...
    value: function makeCalander() {
      ...
      var _iterator = _createForOfIteratorHelper(this.dayList),
          _step;
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          var curDay = _day.substring(0, 3);

          var curDayData = document.createElement('td');
          curDayData.textContent = curDay;
          if (curDay === 'Sun') curDayData.className = 'sunday';else if (curDay === 'Sat') curDayData.className = 'satday';
      ...
      var lastDay = new Date(this.today.getFullYear(), this.today.getMonth() + 1, 0);
      ...
      for (var i = 0; i < 6; i++) {
        ...
        for (var j = 0; j < 7; j++) {
          ...
          if (!day) {
            ...
            (function () {
              var theDay = new Date(_this2.today.getFullYear(), _this2.today.getMonth(), day);

              var todo = _this2.todoList.find(function (element) {
    ...
    value: function render() {
      ...
      var calanderWrapper = document.createElement('div');
      calanderWrapper.className = 'calander-content-wrapper';
      var title = this.makeCalanderHeader();
      var table = this.makeCalander();
...
/***/ "./src/client/js/components/Header.js":
/*!********************************************!*\
  !*** ./src/client/js/components/Header.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/client/js/components/TodoModal.js":
/*!***********************************************!*\
  !*** ./src/client/js/components/TodoModal.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _models_Todo__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../models/Todo */ "./src/client/js/models/Todo.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var TodoModal = /*#__PURE__*/function () {
  function TodoModal(_ref) {
    var $target = _ref.$target,
        todoList = _ref.todoList,
        calRender = _ref.calRender;
  ...
  _createClass(TodoModal, [{
    ...
    key: "setState",
    value: function setState(theDay) {
      this.toggleModal();
      this.date = theDay;
      this.render();
    }
    ...
    key: "makeModalHeader",
    value: function makeModalHeader() {
      var _this = this;
    ...
    value: function makeModalBody() {
      ...
      var modaltodoRow2 = document.createElement('div');
    ...
    key: "makeModalFooter",
    value: function makeModalFooter() {
      var _this2 = this;
...
var Todo = function Todo(_ref) {
  var todoName = _ref.todoName,
      todo = _ref.todo,
      todoColor = _ref.todoColor,
      date = _ref.date;
...
/***/ "./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/client/sass/main.scss":
/*!****************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/client/sass/main.scss ***!
  \****************************************************************************************************************/
...
/*!********************************!*\
  ...
  \********************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _App_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./App.js */ "./src/client/js/App.js");
